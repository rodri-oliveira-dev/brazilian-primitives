# Brazilian.PrimitivesTypes Explained

Many Brazilian business systems use national or state identifiers that combine formatting conventions, check digits,
and government context. Brazilian.PrimitivesTypes models the textual identifier contract, not the external registry behind
it.
